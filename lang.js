...
function translatePageContent(language) {
  ...
  const translations = {
      ...
      de: {
          ...
          eletut_1: 'Debrecen, Ausbildungsgymnasium der Lajos Kossuth Universität',
          eletut_2: 'Debrecen, Veterinärstation Tierklinik (Praktikant)',
          ...
          eletut_6: 'Heirat: meine Frau Andrea Dudás',
          eletut_7: '(Kinder: Kristóf 1992, Bálint 1994, Vica 1997)',
          eletut_8: 'Deutschland, Kiel, Christian-Albrechts-Universität',
          eletut_9: '(mit TEMPUS-Stipendium der Universität für Agrarwissenschaften Debrecen)',
          eletut_10: 'PhD-Abschluss (Doktorat in Futtermittelwissenschaft)',
          eletut_11: 'Debrecen, Universität für Agrarwissenschaften (Adjunkt)',
          eletut_12: 'Siófok, Kiliti Veterinärzentrum (angestellter Tierarzt)',
          eletut_13: 'Abschluss der Homöopathie Fachprüfung',
          eletut_14: 'Siófok, Bezirk Tabi (Amtstierarzt)',
          eletut_15: 'Siófok, Tierklinik Klapka-Straße (selbständiger Tierarzt)',
          vissza: 'Zurück',
          //hours page
