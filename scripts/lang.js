...
function translatePageContent(language) {
  ...
  const translations = {
      hu: {
          ...
          zarva: 'zárva',
          zarva2: 'zárva',
          fehervar_hivas: 'Sürgősségi esetben kérem hívja a Székesfehérvári Állatkórházat:',
          fehervar_nev: 'székesfehérvári állatkórház ügyelet',
          kornyeki: 'Vagy keresse meg a környéken:',
          //contact page
      ...
      eng: {
          ...
          zarva: 'closed',
          zarva2: 'closed',
          fehervar_hivas: 'In case of emergency please call the Székesfehérvár Animal Hospital:',
          fehervar_nev: 'on-call service veterinary clinic székesfehérvár',
          kornyeki: 'Or call in the area:',
          //contact page
      ...
      de: {
          ...
          zarva: 'geschlossen',
          zarva2: 'geschlossen',
          fehervar_hivas: 'In Notfällen rufen Sie bitte die Tierklinik Székesfehérvár an:',
          fehervar_nev: 'bereitschaftsdienst tierklinik székesfehérvár',
          kornyeki: 'Oder rufen Sie in der Gegend an:',
          //contact page
