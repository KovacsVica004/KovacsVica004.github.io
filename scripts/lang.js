...
function translatePageContent(language) {
  ...
  const translations = {
      hu: {
          ...
          vissza: 'Vissza',
          //hours page
          nyitvatartas_fontos_text: '2025. szeptember 4-én (csütörtökön) a rendelés szünetel!',
      ...
      eng: {
          ...
          vissza: 'Back',
          //hours page
          nyitvatartas_fontos_text: 'The practice will be closed on September 4th (Thursday).',
      ...
      de: {
          ...
          vissza: 'Zurück',
          //hours page
          nyitvatartas_fontos_text: 'Am 4. September (Donnerstag) bleibt die Praxis geschlossen.',
