...
function translatePageContent(language) {
  ...
  const translations = {
      hu: {
          ...
          vissza: 'Vissza',
          //hours page
          nyitvatartas_fontos_text: '2025. október 23. (csütörtökön) és október 27. (hétfőn) a rendelés szünetel!',
      ...
      eng: {
          ...
          vissza: 'Back',
          //hours page
          nyitvatartas_fontos_text: 'The practice will be closed on October 23th (Thursday) and October 27th (Monday).',
      ...
      de: {
          ...
          vissza: 'Zurück',
          //hours page
          nyitvatartas_fontos_text: 'Am 23. October (Donnerstag) und am 27. October (Montag)bleibt die Praxis geschlossen.',
