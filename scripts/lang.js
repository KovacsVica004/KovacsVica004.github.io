...
function translatePageContent(language) {
  ...
  const translations = {
      hu: {
          ...
          vissza: 'Vissza',
          //hours page
          nyitvatartas_fontos_text: '2025. augusztus 4. és 8. között a rendelés szünetel!',
      ...
      eng: {
          ...
          vissza: 'Back',
          //hours page
          nyitvatartas_fontos_text: 'The practice will be closed from August 4th to 8th.',
      ...
      de: {
          ...
          vissza: 'Zurück',
          //hours page
          nyitvatartas_fontos_text: 'Vom 4. bis 8. August bleibt die Praxis geschlossen.',
