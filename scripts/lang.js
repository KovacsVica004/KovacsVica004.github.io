...
function translatePageContent(language) {
  ...
  const translations = {
      hu: {
          ...
          vissza: 'Vissza',
          //hours page
          nyitvatartas_fontos_text: ' November 29-én (pénteken) a rendelő zárva tart! ',
      ...
      eng: {
          ...
          vissza: 'Back',
          //hours page
          nyitvatartas_fontos_text: ' On November 29 (Friday), the practice will be closed! ',
      ...
      de: {
          ...
          vissza: 'Zurück',
          //hours page
          nyitvatartas_fontos_text: ' Am 29. November (Freitag) bleibt die Praxis geschlossen! ',
